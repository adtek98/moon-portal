      ...
      <div className="px-2 py-5 bg-gray-600 rounded-xl text-sm col-span-4 lg:col-span-2">
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4 lg:col-span-2">
          <div>
            ...
            <div className="bg-gray-700 h-10 rounded-xl flex items-center justify-between">
              <p className="font-semibold mx-2 text-green-500">GOOD</p>
              <Link
                href="/"
                className="bg-gray-800 h-full flex items-center rounded-r-xl hover:bg-gray-900 w-24"
              >
          ...
          <div>
            ...
            <div className="mt-3 bg-gray-700 h-10 rounded-xl flex items-center justify-between">
