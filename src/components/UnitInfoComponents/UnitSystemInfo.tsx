...
export const UnitSystemInfo = ({unit}) => {
    return (
        <>
          <div className='px-2 py-5 bg-gray-600 p-1 rounded rounded-xl col-span-4'>
            <div className='font-bold text-xl mb-3 border border-gray-500 border-x-0 border-t-0 flex justify-between items-end'>
              ...
              <Link href='./edit' as={`/unit/${unit.serialNumber}/edit`} className='text text-gray-500 hover:text-white text-2xl'><FontAwesomeIcon icon={faPenToSquare} /></Link>
            </div>
